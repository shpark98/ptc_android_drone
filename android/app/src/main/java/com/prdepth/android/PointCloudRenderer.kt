 ...
 * Supports touch rotation and pinch zoom.
 */
class PointCloudRenderer : GLSurfaceView.Renderer {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glUniform1f(pointSizeHandle, max(2f, 8f - zoom))
    ...
    private fun generatePoints(
        ...
        for (v in 0 until height step step) {
            for (u in 0 until width step step) {
                ...
                data[idx] = -x  // Negate X to correct left-right mirror
                data[idx + 1] = y
                data[idx + 2] = -z
                data[idx + 3] = r
                data[idx + 4] = g
